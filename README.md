...
- **Revenue at Risk**: $\sum \text{amount\_at\_risk}$ for all active unrecovered cases.
- **Revenue Recovered**: $\sum \text{recovered\_amount}$ for all cases in `RECOVERED` status.
- **Recovery Rate**: $\frac{\text{Revenue Recovered}}{\text{Total Revenue at Risk}} \times 100\%$
- **Attempt Success Rate**: $\frac{\text{Successful Attempts}}{\text{Total Executed Attempts}} \times 100\%$
